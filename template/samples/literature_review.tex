...
There have been a number of recent studies using ABMs focusing on electricity markets, however they often utilize ad-hoc tools which are designed for a particular application. ElecSIM, however, has been built for re-use, expansion and reproducibility \cite{Saxena2019, hadar2019, Kunzel2018}. The survey \cite{Weidlich2008} cites that many of these tools do not release source code or parameters used for studies, which is a problem which ElecSIM seeks to address.
