...
Here we present example scenario runs using ElecSIM. We vary the carbon tax and grow or reduce total electricity demand. This enables us to observe the effects of carbon tax on investment.
...
\begin{figure}
	\includegraphics[width=0.8\linewidth]{figures/scenarios/demand099-carbon18-datetime.png}
	\caption{\textsterling26 to \textsterling150 linearly increasing carbon tax up to the year 2050 with demand decreasing 1\% a year.}
	\label{fig:demand99carbon18}
\end{figure}

\begin{figure}
	\includegraphics[width=0.8\linewidth]{figures/scenarios/demand099-carbon40-datetime.png}
	\caption{{\textsterling40 carbon tax up to the year 2050 with demand decreasing 1\% a year.}}
	\label{fig:demand99carbon40}
\end{figure}
