...
\begin{figure}
	...
	\begin{subfigure}{.8\linewidth}
		\includegraphics[width=\linewidth]{figures/scenarios/demand099-carbon18-datetime-with-legend.png}
		\caption{\textsterling26 to \textsterling150 linearly increasing carbon tax.}
		\label{fig:demand99carbon18}
	\end{subfigure}
	\begin{subfigure}{.8\linewidth}
		\includegraphics[width=\linewidth]{figures/scenarios/demand099-carbon40-datetime-smaller.png}
